...
export default function Sace(props){
    ...
    const yposition1 = useTransform(props.y,[0,4000],[-60,30]);
    const yposition2 = useTransform(props.y,[0,4000],[-200,30]);
    const yposition3 = useTransform(props.y,[0,6000],[-10,60]);
        ...
        <div className='w-full sticky top-28 pb-[100rem] mb-60 flex ' style={{
            ...
            <div className='w-full  flex justify-center items-center px-20 pb-[100rem]' >
                ...
                <div className='w-[45%] h-full pl-0 flex flex-col justify-center items-center'>
                    <motion.div className='absolute w-[23%] flex justify-center items-center mt-7 z-10' style={{
                ...
                <div className='w-6/12 flex flex-col items-end z-10 -ml-14 ' >
                    <div className='w-[100%] flex flex-col pl-40 text-white'>
                        <p className='font-Sgb text-[2.75rem] tracking-wide'>S.A.C.E</p>
                        <p className='text-sm font-CoS tracking-tight pr-28 pt-2'>An augmented reality application that enhances your experience of a destination using cumulative extended user experiences.</p>
                        <p className='text-base font-PoB tracking-tight pr-56 pt-10 tracking-tighter'>My Role</p>
                        <p className='text-sm font-PoR tracking-tight pr-40 pt-0'>Team Lead | Unity Developer</p>
                    </div>
